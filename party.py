...
def is_mel(name, email):
    ...
    True
    >>> is_mel('Lauren Pritchett', 'mel@ubermelon.com')
    True
    >>> is_mel('Mel Melitpolski', 'notmelsemail@ubermelon.com')
    True
...
def most_and_least_common_type(treats):
    ...
    >>> most_and_least_common_type([{'type': 'dessert'}, {'type': 'dessert'}, {'type': 'appetizer'}, {'type': 'dessert'}])
    ('dessert', 'appetizer')
    """
